...
public class Modelo {
    //atributos datos en concreto alo que se esta modelando informacion que se quiere manejar
	//metodo constructor siempre es publico y lleva el nombre de la clase
	//getter&setters
